...
| 🏗️ Class Diagram | [`diagrams/Class_Architecture_Dependencies.mmd`](diagrams/Class_Architecture_Dependencies.png) | Class relationships, dependencies, and inheritance |
